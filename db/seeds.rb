...
100.times do |index|
    index= index+1
    Item.create(name: "タイトル#{index}", description: "ブログの内容#{index}", size: "#{index}",brand: "#{index}", condition: 1.to_i, postage: 1.to_i, region: 1.to_i, delivery_schedule: 1.to_i, price: 1.to_i, transaction_condition: 1.to_i, user_id: 1.to_i)
end
